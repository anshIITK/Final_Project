...
class Asset_Details(db.Model):
    ...
    desk_lap_ram_size = db.Column(db.Integer)
    desk_lap_ram_frequency = db.Column(db.Integer)
    desk_lap_ram_expandable_upto = db.Column(db.Integer)
    desk_lap_no_of_ram_slots =  db.Column(db.Integer)
    desk_lap_hdmi_port = db.Column(db.String(20))
    desk_lap_display_size = db.Column(db.Integer)
    desk_lap_graphics_card_size = db.Column(db.Integer)
    ...
    tab_storage =  db.Column(db.Integer)
    tab_ram_size =  db.Column(db.Integer)
    tab_display_size = db.Column(db.Integer)
    tab_stylus = db.Column(db.String(20))
    tab_connectivity = db.Column(db.String(20))
    monitor_display_size = db.Column(db.Integer)
